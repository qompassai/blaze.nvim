...
function M.get_mojo_cmd()
  ...
  if is_windows then
    table.insert(
      paths,
      vim.env.LOCALAPPDATA and vim.env.LOCALAPPDATA .. '\\Programs\\Mojo\\mojo.exe' or nil
    )
  ...
  table.insert(
    paths,
    vim.env.PIXI_HOME
        and vim.env.PIXI_HOME .. env_path_separator .. 'bin' .. env_path_separator .. 'mojo' .. exe_extension
      or nil
  )
  table.insert(
    paths,
    vim.env.MAGIC_HOME
        and vim.env.MAGIC_HOME .. env_path_separator .. 'bin' .. env_path_separator .. 'magic' .. exe_extension
      or nil
  )
